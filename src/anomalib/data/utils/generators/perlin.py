...
def generate_perlin_noise(
    ...
    This function generates a Perlin noise pattern using a grid-based gradient noise approach.
    The noise is generated by interpolating between randomly generated gradient vectors at grid vertices.
    The interpolation uses a quintic curve for smooth transitions.

    Args:
        height: Desired height of the noise pattern
        width: Desired width of the noise pattern
        scale: Tuple of (scale_x, scale_y) for noise granularity. If None, random scales will be used.
               Larger scales produce coarser noise patterns, while smaller scales produce finer patterns.
...
class PerlinAnomalyGenerator(v2.Transform):
    ...
    def generate_perturbation(
        ...
        Returns:
            tuple[torch.Tensor, torch.Tensor]: Perturbation and mask tensors
        """
